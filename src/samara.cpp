#include "samara.h"
#include "variables.h"
#include "processes/BhyTypeFAO.h"
#include "processes/Bileau.h"
#include "processes/MilBilanCarbone.h"
#include "processes/Risocas2cpp.h"
...
void eval_Par(double t) {
  try {
    double tDay = JulianDayConverter::dayOfYear(t);
