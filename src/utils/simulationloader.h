...
//    virtual void load_meteo(string codestation, string start, string end) = 0;
    ...
    virtual map<string, vector<double>> load_obs(string idsimulation) = 0;
    virtual map<string, vector<double>> load_obs(string plot, string variety, string itinerary, string codestation, double startJulian, double endJulian) = 0;
//    virtual const string getDateFormat() = 0;
};
